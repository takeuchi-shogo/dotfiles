...
- [HANDBOOK.md: A Benchmark for Long-Context Agentic Instruction Following (arXiv:2607.25398)](../../research/2026-07-31-handbook-md-instruction-following-absorb-analysis.md) — 長文standing policyの指示追従ベンチマークを分析、completion-gateの未配線バグ(T3)発見・修正/determinism doc訂正/距離減衰の機序追記など4件採用
