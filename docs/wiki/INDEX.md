...
- **Routine Prompt Rubric — Bulletproof 6 要素 (2026-05-14)** — Khairallah 記事 (content farm 7th) から唯一 Gap 採用。routine prompt の品質を保証する 6 要素 (role/task/process/output/error/constraints) を rubric 化した `references/routine-prompt-rubric.md`。scheduling-decision-table Step 6 + 段階運用・managed-agents-scheduling R1-R5 Recipe Catalog と連携 → 参照: [2026-05-14-claude-code-routines-absorb-analysis](../research/2026-05-14-claude-code-routines-absorb-analysis.md)
