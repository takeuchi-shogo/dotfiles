...
| /epd vs /rpi vs /spike | `.config/claude/skills/*/SKILL.md` description 群 | 仕様確定度 × 規模 |
...
| 決定 | 表の場所 | 概要 |
|---|---|---|
| hook vs instruction 境界 | [`references/determinism-boundary.md`](determinism-boundary.md) *(未作成: 現状 `agent-memory/determinism_boundary.md` に存在)* | 決定論でやる vs プロンプトでやる |
