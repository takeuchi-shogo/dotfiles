...
| 深度 | Plan | Research | Test | Review |
|---|---|---|---|---|
| **Minimal** (S default) | 1行の方針 | 対象ファイルのみ | 修正箇所のみ | 省略可 |
| **Standard** (M default) | 構造化 Plan | モジュール単位 | ユニット+統合 | 2並列 |
| **Comprehensive** (L default) | 詳細 Plan + Decision Log | Brownfield 分析テンプレート参照 | 3層テスト | 4並列+スペシャリスト |
