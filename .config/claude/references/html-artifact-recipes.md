...
- **公式 HTML artifact gallery**: [`github.com/anthropics/html-effectiveness`](https://github.com/anthropics/html-effectiveness) — Anthropic 公式 (2026-05 公開) の HTML 例集。playground recipe の参考に有用 (採用判断は本書の決定表に従う)。本書 R1/R2 を超える新規 recipe を作る前に既存例を確認すること
...
- 記事: Thariq Shihipar "Using Claude Code: The Unreasonable Effectiveness of HTML"
  ...
  - 公式再掲: 2026-05-20, [claude.com/blog](https://claude.com/blog/using-claude-code-the-unreasonable-effectiveness-of-html) — Anthropic 公式 disclaimer "expresses his **personal opinions** – and affinity" 付き
