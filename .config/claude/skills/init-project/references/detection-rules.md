...
| 言語数 | `ls package.json pyproject.toml go.mod Cargo.toml Gemfile mix.exs 2>/dev/null \| wc -l` | 1 | 2 | 3+ | 1.5 |
| CI/CD | `ls .github/workflows/*.yml .gitlab-ci.yml Jenkinsfile 2>/dev/null` | なし | あり | あり+複数 | 2.0 |
