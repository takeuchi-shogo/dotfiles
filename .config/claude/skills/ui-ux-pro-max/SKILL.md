...
> **Full rule details:** Read `instructions/ux-rules.md` for the complete rule catalog (all 10 categories, 150+ individual rules with source guideline references).
...
If the page exists, prioritize its rules.
...
> **Quick Reference rules:** Read `instructions/ux-rules.md` for all rule IDs and descriptions referenced in this table.
...
- **frontend-design:frontend-design と同時起動しない** — 体系参照 (本 skill) と新規 build (frontend-design:frontend-design) は排他。「デザインシステム / a11y / KB」が要件なら本 skill、「新しい UI を作る」が要件なら frontend-design:frontend-design、「既存 UI を磨く」なら impeccable
