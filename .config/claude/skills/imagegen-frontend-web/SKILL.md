...
description: Generate premium per-section website design reference images for landing/marketing pages. CRITICAL — one separate horizontal image FOR EVERY section (8 sections = 8 images, never compress). Enforces composition variety, background-image freedom, varied CTAs and hero scales, narrative spine, consistent palette across all images. Optimized for accurate recreation by coding models.
---
